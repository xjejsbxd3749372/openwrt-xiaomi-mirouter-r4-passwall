...
test -f "${ROOT_DIR}/package/feeds/golang27/golang/Makefile"
test -f "${ROOT_DIR}/package/feeds/golang27/golang/golang-package.mk"
test -f "${ROOT_DIR}/package/feeds/compat23/rust/Makefile"
test -f "${ROOT_DIR}/package/feeds/compat23/rust/rust-package.mk"
test -f "${ROOT_DIR}/package/feeds/modern/lyaml/Makefile"
test -f "${ROOT_DIR}/package/feeds/kcptun/kcptun-client/Makefile"
